<template>
  ...
  <ModalDialog id="creditsModal" :title="t('footer.credits')">
    <template #body>
      <h4><a href="https://boardgamegeek.com/boardgame/210296/dinogenics" target="_blank" rel="noopener">{{t('gameTitle')}}</a></h4>
      <dl>
        <dt>Game design</dt>
        <dd>Richard Keene</dd>
        <dt>Graphics design</dt>
        <dd>Nikola Matkovic, Grzegorz Pedrycz, Tan Ho Sim</dd>
        <dt>Solo Mode Design</dt>
        <dd>Andre K</dd>
        <dt>Publisher</dt>
        <dd><a href="https://www.ninthhaven.com/" target="_blank" rel="noopener">Ninth Heaven Games</a></dd>
      </dl>
      ...
      <dl>
        ...
        <dt>Version</dt>
        <dd>{{buildNumber}} (<a href="https://github.com/brdgm/dinogenics-solo-helper/releases" target="_blank" rel="noopener">Change Log</a>)</dd>
        <dt>Source Code (Apache-2.0 License)</dt>
        <dd><a href="https://github.com/brdgm/dinogenics-solo-helper" target="_blank" rel="noopener">https://github.com/brdgm/dinogenics-solo-helper</a></dd>
      </dl>
