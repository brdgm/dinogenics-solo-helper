...
describe('util/isDinosaurAvailable', () => {
  it('BRONTOSAURUS', () => {
    ...
    expect(isDinosaurAvailable(Dinosaur.BRONTOSAURUS, [Module.NEW_ARRIVALS])).to.true
  })
  ...
  it('GALLIMIMUS', () => {
    ...
    expect(isDinosaurAvailable(Dinosaur.GALLIMIMUS, [Module.NEW_ARRIVALS])).to.false
  })
  ...
  it('DREADNOUGHTUS', () => {
    ...
    expect(isDinosaurAvailable(Dinosaur.DREADNOUGHTUS, [Module.NEW_ARRIVALS])).to.false
  })
  ...
  it('QUETZALCOATLUS', () => {
    ...
    expect(isDinosaurAvailable(Dinosaur.QUETZALCOATLUS, [Module.NEW_ARRIVALS])).to.true
  })
})
